...
format: html
warning: false
Author: "Megan Hessel, Mallory Wang, Isabella Segarra"
date: Jan 28, 2026
---

# Almond Profit Model - Informal Sensitivity Analysis
### EDS230 Assignment 4

Megan Hessel, Mallory Wang, Isabella Segarra
...
source(here::here("assignment3","R", "almond_yield_function.R"))
...
# Use pmap with wrapper (because the `almond_profit_function` needs a dataframe, not scalars like the solar model). 
...
# Add parameter values to the profit results 
